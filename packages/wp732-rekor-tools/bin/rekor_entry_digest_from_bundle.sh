...
# the rekor digest which can later be used to lookup the inclusionProof that rekor created for the
# artifact entry in the rekor log by passing the digest to rekor_entry_inclusionproof_from_entry_digest.sh
